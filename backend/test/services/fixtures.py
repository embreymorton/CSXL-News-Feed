...
@pytest.fixture()
def newspost_svc_integration(session: Session):
    """This fixture is used to test the NewsPostService class with a real PermissionService."""
    return NewsPostService(session, PermissionService(session))
